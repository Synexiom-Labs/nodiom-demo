/**
 * The demo document, in one place.
 *
 * Every script that needs a clean starting state imports from here, so the
 * fixture can never drift between demos.
 */

import { writeFileSync } from 'node:fs';

export const WIKI_PATH = './wiki.md';

export const ORIGINAL = `# Project Atlas
...
export function resetWiki() {
  writeFileSync(WIKI_PATH, ORIGINAL);
}
